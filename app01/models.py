...
class Task(models.Model):
    ...
    level = models.SmallIntegerField(
        verbose_name="任务等级", choices=level_choices, default=1
    )
...
class Order(models.Model):
    ...
    status = models.SmallIntegerField(
        verbose_name="订单状态", choices=status_choices, default=1
    )
    user = models.ForeignKey(
        verbose_name="下单用户", to="Admin", to_field="id", on_delete=models.CASCADE
    )
